function set_halcyon_vars () {
	...
	if ! (( ${HALCYON_INTERNAL_VARS_INHERITED_ONCE_AND_RESET:-0} )); then
		...
		export HALCYON_WITH_BUILD_TOOLS="${HALCYON_WITH_BUILD_TOOLS:-}"
		export HALCYON_WITH_HELPER_APPS="${HALCYON_WITH_HELPER_APPS:-}"
		...
		export HALCYON_WITH_BUILD_TOOLS=
		export HALCYON_WITH_HELPER_APPS=
		...
		export HALCYON_NO_INSTALL_GHC=0
		export HALCYON_NO_INSTALL_CABAL=0
		export HALCYON_NO_INSTALL_SANDBOX=0
		export HALCYON_NO_INSTALL_APP=0
