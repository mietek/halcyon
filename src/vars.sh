function set_halcyon_vars () {
	...
	if ! (( ${HALCYON_INTERNAL_VARS_SET_ONCE_AND_INHERITED:-0} )); then
		...
		export HALCYON_AS_BUILDTIME_DEP="${HALCYON_AS_BUILDTIME_DEP:-0}"
		export HALCYON_AS_RUNTIME_DEP="${HALCYON_AS_RUNTIME_DEP:-0}"
	...
	if ! (( ${HALCYON_INTERNAL_VARS_INHERITED_ONCE_AND_RESET:-0} )); then
		...
		export HALCYON_SANDBOX_FLAGS="${HALCYON_SANDBOX_FLAGS:-}"
		export HALCYON_APP_FLAGS="${HALCYON_APP_FLAGS:-}"
		...
		export HALCYON_SANDBOX_FLAGS=
		export HALCYON_APP_FLAGS=
